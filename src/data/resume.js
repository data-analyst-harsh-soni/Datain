export const resumeData = {
  ...
  github: "https://github.com/data-analyst-harsh-soni",
  pdfUrl: "/assets/resume/Harsh_Soni_Resume.pdf",
  profilePhotoUrl: "/assets/profile/profile-photo.jpeg",
  summary: "Final-year Computer Science student and Data Analyst with hands-on experience across Power BI, SQL, and Python — built dashboards processing 35M+ records and ETL pipelines that cut processing latency by 20%. Led a 25-person analytics team at The Entrepreneurship Network while delivering 5 end-to-end BI projects, from risk modeling to enrollment intelligence. Comfortable owning a dataset from raw extraction through to a stakeholder-ready dashboard.",
  personalIntro: "I turn complex data into intelligent systems, actionable insights, and decision-ready experiences. My focus lies at the intersection of data architecture, analytics engineering, and business intelligence — crafting systems that don't just display numbers, but guide real-world decisions.",
  education: {
